...
int setup() {
    ...
    tty.c_cc[VTIME] = 0; //Wait up to VTIME s, returning as soon as any data is received
    tty.c_cc[VMIN] = 16; // Wait until programm receives VMIN characters;
    ...
    //sleep(5000);        //gather data for 5 s
